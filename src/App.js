...
const TALKS = [
  ...
  { id: 19,  title: "WEF Davos 2026 — Conversation with Jensen Huang",  person: "Jensen Huang",  org: "NVIDIA",  year: 2026,  duration: "40m",  category: ["tech", "founders", "investors", "wef"],  tags: ["AI", "Chips", "Infrastructure", "Davos"],  featured: false,  accent: "#16a34a", description: "NVIDIA CEO Jensen Huang — making his first-ever Davos appearance — talks to Larry Fink about AI as a platform shift, the future of computing, jobs, and why every nation needs its own AI.",  youtubeId: "hoDYYCyxMuE" },
];
